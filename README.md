...
3. Настройки → Устройства и службы → Добавить интеграцию → **Techlan ARM**.
...
---
## Description
Control of Bolide ServerSkif fire/security system (Techlan ARM).
### Features
...
3. Settings → Devices & Services → Add Integration → **Techlan ARM**.
